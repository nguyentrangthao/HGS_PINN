...
function [train_net, mse] =HGSANN_pinn(inputs,targets,n,act_func1,act_func2,N,FEs)
...
tic
[Destination_fitness,bestPositions,besthist_pinn,Convergence_curve]=HGS(N,FEs,lb,ub,dim,@objfunc_pinn);
time=toc
