...
function [train_net, mse] =HGSANN3var(inputs,targets,n,act_func1,act_func2,N,FEs)
...
tic
[Destination_fitness,bestPositions,besthist,Convergence_curve]=HGS(N,FEs,lb,ub,dim,@objfunc3vars);
time=toc
